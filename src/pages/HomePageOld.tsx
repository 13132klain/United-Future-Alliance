import { ArrowRight, Users, Target, Shield, Lightbulb, Calendar, BookOpen, TrendingUp, X, MapPin, Clock, Mail, Phone, ExternalLink, CheckCircle, Star } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            ...
            <div className="flex justify-center lg:block">
              <div className="relative w-full max-w-lg lg:max-w-none animate-fade-in-right delay-500">
                {/* Main Hero Image */}
                <img 
                  src="https://images.pexels.com/photos/1072824/pexels-photo-1072824.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop" 
                  alt="United Future Alliance - Building Kenya's Future Together"
                  className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] object-cover transition-all duration-500 hover:scale-105"
                />
              </div>
            </div>
          </div>
